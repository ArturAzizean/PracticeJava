...
Vue.component('messages-list', {
    ...
    data: function(){
        return {
            message: null // При нажатии на edit измененная строка будет добавляться в эту переменную.
        }
    },
    template:
        ...
        '</div>',
    created: function () {  // через цикл добавляет к каждой строчке этот метод.
